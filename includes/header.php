...
<head>
    ...
    <link rel="stylesheet" href="/kelulusan2025/assets/css/animations.css">
</head>
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-nu shadow-sm sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/kelulusan2025/">
                <img src="/kelulusan2025/assets/images/logo/logo-skanu.png" alt="<?php echo $school_name; ?>" class="school-logo me-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/kelulusan2025/">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/kelulusan2025/#cek-kelulusan">Cek Kelulusan</a>
                    </li>
                    <?php if (is_logged_in()): ?>
